...
When [`boolean_restart`](restart.md) = _t_, the elements/nodes/atoms are read from the [`cac_in.restart`](../chapter-3/input.md) file, in which case all commands in the _Simulation Cell_ category below become irrelevant; otherwise, the simulation cell is built from scratch.
...
* _Settings_
	...
	[cal](cal.md), [constrain](constrain.md), [dump](dump.md), [dynamics](dynamics.md), [element](element.md), [group\_num](group_num.md), [group](group.md), [limit](limit.md), [minimize](minimize.md), [neighbor](neighbor.md), [simulator](simulator.md), [temperature](temperature.md)
