...
where `upper_b` is the upper boundary of the simulation cell, similar to that in the [group](group.md) command. The `depth` is in unit of the [lattice periodicity length](../chapter8/lattice-space.md) along the corresponding axis.
